...
{    
    public partial class Login : System.Web.UI.Page
    {
        ...
        public void checkUser()
        {
            ...
            ds = new DataSet();
            /* Comando SQL */
            cmd.CommandText = "SELECT * FROM usuario WHERE email='" + txbEmail.Text + "' AND senha='"+txbPass.Text+"'";
            /* Conexão com Banco */
            cmd.Connection = con;
        ...
        {
            Lista.Items.Add(Txt1.Text);
            Lista.Items.Add(Txt2.Text);
            Lista.Items.Add(Txt3.Text);
