...
namespace AppWebAspLoginUsuario
{
    public partial class Dashboard : System.Web.UI.Page
    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            dt = new DataTable();
            /* Comando SQL */
            cmd.CommandText = "UPDATE usuario  SET email='" + txbEmail.Text.ToString() + "', pass='" + txbPass.Text.ToString() + "' WHERE id_user='"+id_user+"'";
            /* Abre a Conexão */
            cmd.Connection = con;
            /* Executa a Query SQL */
            cmd.ExecuteNonQuery();
        ...
        public void dataShow()
        {
            ...
            int id_user = Convert.ToInt32(cookie.Value);
            /* Comando SQL */
            cmd.CommandText = "SELECT * FROM usuario WHERE id_user='"+id_user+"'";
            /* Conexão com Banco */
            cmd.Connection = con;
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            dt = new DataTable();
            /* Comando SQL */
            cmd.CommandText = "DELETE usuario WHERE id_user='" + id_user + "'";
            /* Abre a Conexão */
            cmd.Connection = con;
            /* Executa a Query SQL */
            cmd.ExecuteNonQuery();
